package com.breezebiochemph.features.dashboard.presentation
...
import com.breezebiochemph.*
import com.breezebiochemph.R
import com.breezebiochemph.app.*
import com.breezebiochemph.app.NewFileUtils.browseDocuments
import com.breezebiochemph.app.NewFileUtils.browsePDFDocuments
import com.breezebiochemph.app.NewFileUtils.getExtension
import com.breezebiochemph.app.domain.*
import com.breezebiochemph.app.types.DashboardType
import com.breezebiochemph.app.types.FragType
import com.breezebiochemph.app.types.TopBarConfig
import com.breezebiochemph.app.uiaction.DisplayAlert
import com.breezebiochemph.app.utils.*
import com.breezebiochemph.app.utils.AppUtils.Companion.isProfile
import com.breezebiochemph.base.BaseResponse
import com.breezebiochemph.base.presentation.BaseActivity
import com.breezebiochemph.base.presentation.BaseFragment
import com.breezebiochemph.features.NewQuotation.*
import com.breezebiochemph.features.NewQuotation.api.GetQuotRegProvider
import com.breezebiochemph.features.NewQuotation.model.ViewDetailsQuotResponse
import com.breezebiochemph.features.SearchLocation.SearchLocationFragment
import com.breezebiochemph.features.SearchLocation.locationInfoModel
import com.breezebiochemph.features.TA.ViewAllTAListFragment
import com.breezebiochemph.features.achievement.AchievementFragment
import com.breezebiochemph.features.activities.presentation.*
import com.breezebiochemph.features.addAttendence.*
import com.breezebiochemph.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.breezebiochemph.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.breezebiochemph.features.addAttendence.model.GetReportToFCMResponse
import com.breezebiochemph.features.addAttendence.model.GetReportToResponse
import com.breezebiochemph.features.addAttendence.model.Leave_list_Response
import com.breezebiochemph.features.addorder.presentation.AddOrderFragment
...
import com.breezebiochemph.features.addshop.presentation.AddShopFragment
import com.breezebiochemph.features.addshop.presentation.OTPVerificationDialog
import com.breezebiochemph.features.addshop.presentation.ScanImageFragment
import com.breezebiochemph.features.addshop.presentation.ShowCardDetailsDialog
import com.breezebiochemph.features.alarm.model.AlarmData
import com.breezebiochemph.features.alarm.presetation.AttendanceReportFragment
import com.breezebiochemph.features.alarm.presetation.PerformanceReportFragment
import com.breezebiochemph.features.alarm.presetation.VisitReportDetailsFragment
import com.breezebiochemph.features.alarm.presetation.VisitReportFragment
import com.breezebiochemph.features.attendance.AttendanceFragment
import com.breezebiochemph.features.attendance.api.AttendanceRepositoryProvider
import com.breezebiochemph.features.attendance.model.AttendanceRequest
import com.breezebiochemph.features.attendance.model.AttendanceResponse
import com.breezebiochemph.features.averageshop.presentation.AverageShopFragment
import com.breezebiochemph.features.avgorder.presentation.AverageOrderFragment
import com.breezebiochemph.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.breezebiochemph.features.beatCustom.TeamBeatListFragment
import com.breezebiochemph.features.billing.presentation.AddBillingFragment
import com.breezebiochemph.features.billing.presentation.BillingDetailsFragment
import com.breezebiochemph.features.billing.presentation.BillingListFragment
import com.breezebiochemph.features.changepassword.presentation.ChangePasswordDialog
import com.breezebiochemph.features.chat.model.ChatListDataModel
import com.breezebiochemph.features.chat.model.ChatUserDataModel
import com.breezebiochemph.features.chat.model.GroupUserDataModel
import com.breezebiochemph.features.chat.presentation.*
import com.breezebiochemph.features.chatbot.presentation.ChatBotFragment
import com.breezebiochemph.features.chatbot.presentation.ChatBotShopListFragment
import com.breezebiochemph.features.chatbot.presentation.ReportsFragment
import com.breezebiochemph.features.chatbot.presentation.SelectLanguageDialog
import com.breezebiochemph.features.commondialog.presentation.CommonDialog
import com.breezebiochemph.features.commondialog.presentation.CommonDialogClickListener
import com.breezebiochemph.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.breezebiochemph.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.breezebiochemph.features.commondialogsinglebtn.OnDialogClickListener
import com.breezebiochemph.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.breezebiochemph.features.contacts.ActivityDtlsFrag
import com.breezebiochemph.features.contacts.AddOpptFrag
import com.breezebiochemph.features.contacts.ContactDtls
import com.breezebiochemph.features.contacts.ContactGr
import com.breezebiochemph.features.contacts.ContactsAddFrag
import com.breezebiochemph.features.contacts.ContactsFrag
import com.breezebiochemph.features.contacts.SchedulerAddFormFrag
import com.breezebiochemph.features.contacts.SchedulerViewFrag
import com.breezebiochemph.features.contacts.TemplateAddFrag
import com.breezebiochemph.features.contacts.TemplateViewFrag
import com.breezebiochemph.features.contacts.ViewCrmOpptFrag
import com.breezebiochemph.features.dailyPlan.prsentation.AllShopListFragment
import com.breezebiochemph.features.dailyPlan.prsentation.DailyPlanListFragment
import com.breezebiochemph.features.dailyPlan.prsentation.PlanDetailsFragment
import com.breezebiochemph.features.damageProduct.ShopDamageProductListFrag
import com.breezebiochemph.features.damageProduct.ShopDamageProductSubmitFrag
import com.breezebiochemph.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.breezebiochemph.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.breezebiochemph.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.breezebiochemph.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.breezebiochemph.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.breezebiochemph.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.breezebiochemph.features.dashboard.presentation.model.ContentListResponseModel
import com.breezebiochemph.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.breezebiochemph.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.breezebiochemph.features.device_info.presentation.DeviceInfoListFragment
import com.breezebiochemph.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.breezebiochemph.features.document.DocumentRepoFeatureNewFragment
import com.breezebiochemph.features.document.presentation.DocumentListFragment
import com.breezebiochemph.features.document.presentation.DocumentTypeListFragment
import com.breezebiochemph.features.document.presentation.OpenFileWebViewFragment
import com.breezebiochemph.features.dymanicSection.presentation.AddDynamicFragment
import com.breezebiochemph.features.dymanicSection.presentation.AllDynamicListFragment
import com.breezebiochemph.features.dymanicSection.presentation.DynamicListFragment
import com.breezebiochemph.features.dymanicSection.presentation.EditDynamicFragment
import com.breezebiochemph.features.gpsDisabilityScreen.GpsDisableFragment
import com.breezebiochemph.features.home.presentation.HomeFragment
import com.breezebiochemph.features.homelocation.presentation.HomeLocationFragment
import com.breezebiochemph.features.homelocation.presentation.HomeLocationMapFragment
import com.breezebiochemph.features.know_your_state.KnowYourStateFragment
import com.breezebiochemph.features.lead.LeadFrag
import com.breezebiochemph.features.lead.ViewLeadFrag
import com.breezebiochemph.features.leaderboard.LeaderBoardFrag
import com.breezebiochemph.features.leaveapplynew.LeaveHome
import com.breezebiochemph.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.breezebiochemph.features.localshops.LocalShopListFragment
import com.breezebiochemph.features.localshops.LocalShopListMapFragment
import com.breezebiochemph.features.localshops.NearByShopsMapFragment
import com.breezebiochemph.features.location.*
import com.breezebiochemph.features.location.api.LocationRepoProvider
import com.breezebiochemph.features.location.model.*
import com.breezebiochemph.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.breezebiochemph.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.breezebiochemph.features.login.ShopFeedbackEntity
import com.breezebiochemph.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.breezebiochemph.features.login.presentation.LoginActivity
import com.breezebiochemph.features.logout.presentation.api.LogoutRepositoryProvider
import com.breezebiochemph.features.logoutsync.presentation.LogoutSyncFragment
import com.breezebiochemph.features.marketAssist.MarketAssistTabFrag
import com.breezebiochemph.features.marketAssist.ShopDtlsMarketAssistFrag
import com.breezebiochemph.features.marketAssist.ShopListMarketAssistFrag
import com.breezebiochemph.features.marketing.presentation.MarketingPagerFragment
import com.breezebiochemph.features.meetinglist.prsentation.MeetingListFragment
import com.breezebiochemph.features.member.MapViewForTeamFrag
import com.breezebiochemph.features.member.model.TeamLocDataModel
import com.breezebiochemph.features.member.model.TeamShopListDataModel
import com.breezebiochemph.features.member.presentation.*
import com.breezebiochemph.features.menuBeat.MenuBeatFrag
import com.breezebiochemph.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.breezebiochemph.features.micro_learning.presentation.MicroLearningListFragment
import com.breezebiochemph.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.breezebiochemph.features.myallowancerequest.MyallowanceRequestFragment
import com.breezebiochemph.features.myjobs.model.CustomerDataModel
import com.breezebiochemph.features.myjobs.presentation.*
import com.breezebiochemph.features.mylearning.MyLearningFragment
import com.breezebiochemph.features.myorder.presentation.MyOrderListFragment
import com.breezebiochemph.features.myprofile.presentation.MyProfileFragment
import com.breezebiochemph.features.nearbyshops.api.ShopListRepositoryProvider
import com.breezebiochemph.features.nearbyshops.model.ShopData
import com.breezebiochemph.features.nearbyshops.model.ShopListResponse
import com.breezebiochemph.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.breezebiochemph.features.nearbyshops.presentation.BeatListFragment
import com.breezebiochemph.features.nearbyshops.presentation.NearByShopsListFragment
import com.breezebiochemph.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.breezebiochemph.features.nearbyshops.presentation.ShopCallHisFrag
import com.breezebiochemph.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.breezebiochemph.features.newcollection.CollectionDetailsStatusFragment
import com.breezebiochemph.features.newcollection.CollectionShopListFragment
import com.breezebiochemph.features.newcollection.NewCollectionListFragment
import com.breezebiochemph.features.newcollectionreport.*
import com.breezebiochemph.features.notification.NotificationFragment
import com.breezebiochemph.features.orderITC.CartListFrag
import com.breezebiochemph.features.orderITC.OrderListFrag
import com.breezebiochemph.features.orderITC.ProductListFrag
import com.breezebiochemph.features.orderITC.ViewNewOrdHisAllFrag
import com.breezebiochemph.features.orderITC.ViewNewOrdHistoryFrag
import com.breezebiochemph.features.orderITC.ViewOrdDtls
import com.breezebiochemph.features.orderList.NewDateWiseOrderListFragment
import com.breezebiochemph.features.orderList.NewOrderListFragment
import com.breezebiochemph.features.orderList.OrderListFragment
import com.breezebiochemph.features.orderdetail.presentation.OrderDetailFragment
import com.breezebiochemph.features.orderhistory.ActivityMapFragment
import com.breezebiochemph.features.orderhistory.OrderhistoryFragment
import com.breezebiochemph.features.orderhistory.TimeLineFragment
import com.breezebiochemph.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezebiochemph.features.orderhistory.model.FetchLocationRequest
import com.breezebiochemph.features.orderhistory.model.FetchLocationResponse
import com.breezebiochemph.features.orderhistory.model.LocationData
import com.breezebiochemph.features.pendinglocationinout.PendingOutLocationFrag
import com.breezebiochemph.features.performance.GpsStatusFragment
import com.breezebiochemph.features.performance.PerformanceFragment
import com.breezebiochemph.features.performance.api.UpdateGpsStatusRepoProvider
import com.breezebiochemph.features.performance.model.UpdateGpsInputParamsModel
import com.breezebiochemph.features.performanceAPP.OwnPerformanceFragment
import com.breezebiochemph.features.performanceAPP.PerformanceAppFragment
import com.breezebiochemph.features.performanceAPP.allPerformanceFrag
import com.breezebiochemph.features.permissionList.ViewPermissionFragment
import com.breezebiochemph.features.photoReg.*
import com.breezebiochemph.features.privacypolicy.PrivacypolicyWebviewFrag
import com.breezebiochemph.features.quotation.presentation.*
import com.breezebiochemph.features.reimbursement.presentation.*
import com.breezebiochemph.features.report.presentation.*
import com.breezebiochemph.features.returnsOrder.*
import com.breezebiochemph.features.settings.presentation.SettingsFragment
import com.breezebiochemph.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.breezebiochemph.features.shopdetail.presentation.*
import com.breezebiochemph.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezebiochemph.features.stock.StockDetailsFragment
import com.breezebiochemph.features.stock.StockListFragment
import com.breezebiochemph.features.stockAddCurrentStock.AddShopStockFragment
import com.breezebiochemph.features.stockAddCurrentStock.UpdateShopStockFragment
import com.breezebiochemph.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.breezebiochemph.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.breezebiochemph.features.stockCompetetorStock.AddCompetetorStockFragment
import com.breezebiochemph.features.stockCompetetorStock.CompetetorStockFragment
import com.breezebiochemph.features.stockCompetetorStock.ViewComStockProductDetails
import com.breezebiochemph.features.survey.SurveyFrag
import com.breezebiochemph.features.survey.SurveyViewDtlsFrag
import com.breezebiochemph.features.survey.SurveyViewFrag
import com.breezebiochemph.features.task.presentation.AddTaskFragment
import com.breezebiochemph.features.task.presentation.CalenderTaskFragment
import com.breezebiochemph.features.task.presentation.EditTaskFragment
import com.breezebiochemph.features.task.presentation.TaskListFragment
import com.breezebiochemph.features.taskManagement.TaskManagementFrag
import com.breezebiochemph.features.taskManagement.ViewTaskManagementFrag
import com.breezebiochemph.features.timesheet.presentation.AddTimeSheetFragment
import com.breezebiochemph.features.timesheet.presentation.EditTimeSheetFragment
import com.breezebiochemph.features.timesheet.presentation.TimeSheetListFragment
import com.breezebiochemph.features.viewAllOrder.CartFragment
import com.breezebiochemph.features.viewAllOrder.OrderTypeListFragment
import com.breezebiochemph.features.viewAllOrder.ViewAllOrderListFragment
import com.breezebiochemph.features.viewAllOrder.ViewCartFragment
import com.breezebiochemph.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.breezebiochemph.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.breezebiochemph.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.breezebiochemph.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.breezebiochemph.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.breezebiochemph.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.breezebiochemph.features.viewPPDDStock.ViewOutstandingFragment
import com.breezebiochemph.features.viewPPDDStock.ViewPPDDListFragment
import com.breezebiochemph.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.breezebiochemph.features.viewPPDDStock.ViewStockFragment
import com.breezebiochemph.features.weather.presentation.WeatherFragment
import com.breezebiochemph.mappackage.MapActivity
import com.breezebiochemph.mappackage.MapActivityWithoutPath
import com.breezebiochemph.mappackage.SendBrod
import com.breezebiochemph.widgets.AppCustomEditText
import com.breezebiochemph.widgets.AppCustomTextView
...
import com.breezebiochemph.features.mylearning.KnowledgeHubAllVideoList
import com.breezebiochemph.features.mylearning.LeaderboardLmsFrag
import com.breezebiochemph.features.mylearning.LmsQuestionAnswerSet
import com.breezebiochemph.features.mylearning.MyLearningAllVideoList
import com.breezebiochemph.features.mylearning.MyPerformanceFrag
import com.breezebiochemph.features.mylearning.NotificationLMSFragment
import com.breezebiochemph.features.mylearning.SearchLmsFrag
import com.breezebiochemph.features.mylearning.SearchLmsKnowledgeFrag
import com.breezebiochemph.features.mylearning.SearchLmsLearningFrag
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xbreezebiochemphlogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezebiochemphlogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.breezebiochemph/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezebiochemphlogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezebiochemphlogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezebiochemphlogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezebiochemphlogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
