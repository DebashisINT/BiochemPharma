package com.breezebiochemph.features.permissionList
...
import com.breezebiochemph.test.viewPermission.AdapterViewPermission
        ...
        for(i in 0..list.size-1){
            if(list1.get(i)!="android.permission.ACCESS_GPS") {
                var obj: PermissionDetails = PermissionDetails(list1.get(i).replace("android.permission.", "").replace("_", " ")
                        ...
                        replace("com.breezebiochemph.permission.C2D",""), list.get(i))
