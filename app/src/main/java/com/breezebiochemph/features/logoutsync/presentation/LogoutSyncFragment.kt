package com.breezebiochemph.features.logoutsync.presentation
...
import com.breezebiochemph.CustomConstants


import com.breezebiochemph.R
import com.breezebiochemph.app.AppDatabase
...
import com.breezebiochemph.app.utils.Toaster
import com.breezebiochemph.base.BaseResponse
import com.breezebiochemph.base.presentation.BaseActivity
import com.breezebiochemph.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezebiochemph.features.billing.api.AddBillingRepoProvider
import com.breezebiochemph.features.billing.model.AddBillingInputParamsModel
...
import com.breezebiochemph.features.dashboard.presentation.ReasonDialog
...
import com.breezebiochemph.features.document.model.AddEditDocumentInputParams
import com.breezebiochemph.features.document.model.DocumentAttachmentModel
...
import com.breezebiochemph.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.breezebiochemph.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.breezebiochemph.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezebiochemph.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezebiochemph.features.orderhistory.model.*
...
import com.breezebiochemph.features.quotation.model.AddQuotInputModel
import com.breezebiochemph.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezebiochemph.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezebiochemph.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezebiochemph.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezebiochemph.features.timesheet.model.AddTimeSheetInputModel
import com.breezebiochemph.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezebiochemph.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezebiochemph.features.viewAllOrder.model.AddOrderInputProductList
import com.breezebiochemph.mappackage.SendBrod
import com.breezebiochemph.widgets.AppCustomTextView
import com.breezebiochemph.MonitorService
import com.breezebiochemph.MySingleton
import com.breezebiochemph.app.AlarmReceiver
...
import com.breezebiochemph.features.addshop.presentation.ShopExtraContactReq
...
import com.breezebiochemph.features.login.model.GetConcurrentUserResponse
...
import com.breezebiochemph.features.orderITC.SyncDeleteOpptL
import com.breezebiochemph.features.orderITC.SyncEditOppt
import com.breezebiochemph.features.orderITC.SyncOppt
import com.breezebiochemph.features.orderITC.SyncOpptProductL
import com.breezebiochemph.features.orderITC.SyncOrd
import com.breezebiochemph.features.orderITC.SyncOrdProductL
import com.breezebiochemph.features.performance.model.Gps_status_list
import com.breezebiochemph.features.performance.model.UpdateGpsInputListParamsModel
import com.breezebiochemph.features.returnsOrder.ReturnProductList
import com.breezebiochemph.features.returnsOrder.ReturnRequest
import com.breezebiochemph.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezebiochemphlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezebiochemphlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezebiochemphlogsample/log.zip").path);
